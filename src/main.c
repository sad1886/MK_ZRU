...
//	float tHour;
	...
	// Пока просто закоммнетировали, чтобы не мешалось - потом станет ясно, как переписать 8 пакет, учитывая, что теперь это просто команда ВКЛ ТЕСТ с параметром ЭТВЦ
