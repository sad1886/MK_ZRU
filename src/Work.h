...
//#define vhCount2				120									// 2 часа в сек (2*60*60)
...
#define dt5							5										// Дельта времени 5 сек при ТВЦ
#define dtRazr					20									// Дельта времени 20 сек при Разряде
...
#define	dU_u_def 			0.07									// Максимально допусстимый разброс давления ΔДу
#define	dP_u_def 			6.0										// Максимально допусстимый разброс напряжений ΔUр 
...
#define	aIkomp							3								// Ток компенсационного заряда < 2A
...
// байт 3 ========================================================================
#define bready							0x80						//Готовность контроллера на этапе ТВЦ Вкл РС
